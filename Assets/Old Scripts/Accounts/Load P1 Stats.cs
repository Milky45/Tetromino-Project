...
public class LoadP1Stats : MonoBehaviour
{
    ...
    private void LoadPlayer1Stats()
    {
        using (var connection = GetConnection())
        {
            ...
            float survivalTimeSeconds = 0;

            // Step 1: Get the username of the active Player 1
            using (var cmd = connection.CreateCommand())
            {
                ...
                if (result == null)
                {
                    Debug.LogWarning("No Player 1 is currently logged in.");
