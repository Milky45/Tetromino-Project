...
public class PieceController : MonoBehaviour
{
    ...
    public void Start()
    {
        moveLeft = controls.VsModeP1.MoveLeft;
        moveRight = controls.VsModeP1.MoveRight;
        moveDown = controls.VsModeP1.MoveDown;

        controls.VsModeP1.RotateToLeft.performed += ctx => TryRotate(1);
        controls.VsModeP1.RotateToRight.performed += ctx => TryRotate(-1);
        controls.VsModeP1.Hold.performed += ctx => gameManager.TryHoldPiece(data, this);
        controls.VsModeP1.HardDrop.performed += ctx => HardDrop();
