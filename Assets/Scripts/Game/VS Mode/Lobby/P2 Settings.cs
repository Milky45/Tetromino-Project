...
public class P2Settings : MonoBehaviour
{
    ...
    public static int chosenInterval = 1; // Default interval value
    ...
    private void Start()
    {
        ...
        int currentGearShift = GearAnimatorP2.ShiftInterval;
    ...
    public void OnClickSubmit()
    {
        ...
        GameManagerP2.movementSensitivity = chosenSens; // Update game manager sensitivity
        GearAnimatorP2.ShiftInterval = chosenInterval; // Update the interval for the animator
        PlayerPrefs.SetInt("P2SensitivityIndex", currentIndex); // Save index
        PlayerPrefs.SetInt("P2ShiftInterval", currentIntervalIndex); // Save interval
        PlayerPrefs.Save(); // Ensure it's written to disk
        Debug.Log($"P2 Move Sensitivity Set: {MoveSens_Text.text} (Delay = {chosenSens}, Array Index = {currentIndex})");
        Debug.Log($"P2 Shift Interval Set: {ShiftInterval[currentIntervalIndex]}");
    }
    ...
    {
        Debug.Log($"P2 GetShiftInterval {chosenInterval}");
